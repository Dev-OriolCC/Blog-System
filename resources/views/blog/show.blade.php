...
@section('header')
    <header class="header text-white h-fullscreen pb-80" style="background-image: url('http://localhost/blog-system/public/storage/{{$post->image}}')" data-overlay="9">
                ...
                <div id="disqus_thread"></div>
                    <script>
                        ...
                        *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables    */
                        ...
                        s.src = 'https://oriolsblog.disqus.com/embed.js';
